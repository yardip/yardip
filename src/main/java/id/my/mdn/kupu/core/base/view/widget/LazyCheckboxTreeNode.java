 ...
 * @param <E>
 */
public class LazyCheckboxTreeNode<E extends HierarchicalEntity<E>> extends CheckboxTreeNode<E> {

    private final Function<TreeNode<E>, List<TreeNode<E>>> childrenLoader;

    private final Function<TreeNode<E>, Long> childrenCounter;

    public LazyCheckboxTreeNode(E data, TreeNode<E> parent,
    ...
    public boolean equals(Object obj) {
        ...
        final LazyCheckboxTreeNode<E> other = (LazyCheckboxTreeNode<E>) obj;
