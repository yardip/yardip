 ...
 * @param <E>
 */
public class LazyLoadTreeNode<E extends HierarchicalEntity<E>> extends DefaultTreeNode<E> {

    private Function<TreeNode<E>, List<TreeNode<E>>> childrenLoader;

    private final Function<TreeNode<E>, Long> childrenCounter;

    public LazyLoadTreeNode(E data, TreeNode<E> parent,
    ...
    public boolean equals(Object obj) {
        ...
        final LazyLoadTreeNode<E> other = (LazyLoadTreeNode<E>) obj;
