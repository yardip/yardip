...
public class PrimitiveArrayConverter {
     ...
     *
     * @param input The sequence of characters.
     * @param charsetName The character set of the character sequence.
     ...
     * @param charsetName The character set of the byte sequence.
